    ...
    <section className="w-full max-w-6xl">
      ...
      <div className="flex space-x-6 overflow-x-auto pb-4">
        {fakeRaces.map((race, i) => (
          <div
            key={i}
            className="min-w-[250px] bg-gray-50 rounded-2xl shadow hover:shadow-lg transition p-4"
          >
    ...
    <section className="w-full max-w-6xl mt-8">
      ...
      <div className="text-black grid sm:grid-cols-2 gap-6">
        {fakeNews.map((news, i) => (
          <div
            key={i}
            className="bg-gray-50 p-4 rounded-2xl shadow hover:shadow-md transition"
          >
